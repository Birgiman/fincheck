...
export function AuthLayout() {
  return (
    <div className="flex w-full h-full">
      ...
      <div className="w-1/2 h-full justify-center items-center hidden lg:flex">
        <img
          src={illustration}
          className="absolute object-couver w-full h-full max-w-[656px] max-h-[960px] select-none rounded-[32px]"
        />
